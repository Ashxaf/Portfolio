...
export default function CircularGallery({
  ...
  return (
    <div
      className="w-full h-full overflow-hidden cursor-grab bg-transparent active:cursor-grabbing"
      ref={containerRef}
    />
  );
}
